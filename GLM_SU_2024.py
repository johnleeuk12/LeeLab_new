...
def import_data_w_spikes(D_ppc,n,window,c_ind):
    ...
    ED3 = int(6000/window) # 4 seconds post reward lag
...
def glm_per_neuron(n,c_ind, fig_on):
    ...
    # Y2 = Y
    Y2 = ndimage.gaussian_filter(Y,2) #-Y0
    # Y2 = Y
    ...
    for n in np.arange(np.size(D_ppc,0)):
        ...
        if D_ppc[n,4][0][0] > 0:
            try:
                ...
                print("Break, no fit") 
# np.save('SU_IC_0425_R2.npy', Data,allow_pickle= True)     
